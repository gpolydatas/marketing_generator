...
BANNER_SPECS = {
    "leaderboard": {"width": 728, "height": 90, "aspect": "21:9"},
    ...
    "mpu": {"width": 300, "height": 250, "aspect": "4:5"},
    "mobile_banner_300x50": {"width": 300, "height": 50, "aspect": "21:9"},
    "mobile_banner_320x50": {"width": 320, "height": 50, "aspect": "21:9"},
}
...
async def generate_banner(
    ...
    model: str = "imagen4",  # DEFAULT: imagen4
...
Photorealistic, no text"""
            ...
            print(f"📝 IMAGEN PROMPT: {prompt[:200]}...")
...
{f"Weather: {weather_scene}" if weather_scene else ""}"""
    ...
    for part in response.parts:
        if part.inline_data is not None:
            ...
            print(f"✅ IMAGEN 4 generated: {filename}")
...
async def _generate_with_dalle(
    ...
    """Generate with DALL-E 3 (fallback)"""
    ...
    # Build prompt (same logic as before but for DALL-E)
    if scene_only:
        is_photo = any(word in additional_instructions.lower() for word in ['hyperrealistic', 'photorealistic', 'realistic', 'photograph', 'photo', 'camera'])
...
{additional_instructions[:100] if additional_instructions else ""}"""
    ...
    print(f"📝 DALL-E PROMPT: {prompt[:300]}...")
    ...
    print(f"✅ DALL-E 3 generated: {filename}")
